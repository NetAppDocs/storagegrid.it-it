...
---
= Stima il tempo necessario per completare un aggiornamento di StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Esempio: Tempo stimato per l'upgrade a StorageGRID 12.1
...
. Sommare i valori.
+
Dovresti prevedere fino a 18 ore per completare l'upgrade del tuo sistema a StorageGRID 12.1.0.
