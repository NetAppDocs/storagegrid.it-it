...
Esamina questi argomenti per conoscere le nuove funzionalità e i miglioramenti di StorageGRID 12.1, verificare se alcune funzionalità sono state deprecate o rimosse e scoprire le modifiche apportate alle API di StorageGRID.

* link:how-your-system-is-affected-during-upgrade.html["Impatto del sistema durante l'aggiornamento"]
* link:../release-notes/whats-new.html["Novità di StorageGRID 12.1"]
* link:../release-notes/removed-or-deprecated-features.html["Funzionalità rimosse o obsolete"]
* link:../release-notes/changes-to-grid-management-api.html["Modifiche all'API Grid Management"]
* link:../release-notes/changes-to-tenant-management-api.html["Modifiche all'API di gestione del tenant"]
