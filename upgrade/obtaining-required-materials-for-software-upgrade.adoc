...
---
= Ottieni i materiali necessari per un aggiornamento del software StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Documentazione StorageGRID
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Note di rilascio"^]. È necessario accedere con il proprio account NetApp o crearne uno per accedere alle note di rilascio. Assicurarsi di leggerle attentamente prima di iniziare l'aggiornamento.
* https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["Guida alla risoluzione degli aggiornamenti del software StorageGRID"^] per la versione principale a cui stai eseguendo l'upgrade (accesso richiesto)
