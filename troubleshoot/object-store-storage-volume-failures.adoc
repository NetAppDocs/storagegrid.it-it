...
---
= Scopri i guasti dell'archivio di oggetti per i volumi di storage in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_storage_nodes_storage_tables.png["Tabelle di storage dei nodi della pagina Storage Node"]
