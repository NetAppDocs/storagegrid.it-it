...
---
= Conferma le posizioni dei dati degli oggetti in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:object_lookup.png["Pagina Object Lookup (Ricerca oggetto)"]
...
+
image:object_lookup_results.png["Risultati della ricerca di oggetti"]
