...
---
= Risolvi l'avviso degli oggetti potenzialmente persi in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Il supporto tecnico potrebbe chiederti di verificare se è in corso una procedura di ripristino dello storage. Consulta:
