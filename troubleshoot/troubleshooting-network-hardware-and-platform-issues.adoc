...
NOTE: Crea interfacce di rete virtuali separate da usare per il sistema operativo host Linux. Usare le stesse interfacce di rete per il sistema operativo host Linux e il container StorageGRID potrebbe rendere il sistema operativo host irraggiungibile.
