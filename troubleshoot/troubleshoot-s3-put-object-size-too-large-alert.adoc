...
+
.. Accedere a *SUPPORT* > *Tools* > *Logs*. Raccogliere i log delle applicazioni per il nodo di storage nell'avviso. Specificare 15 minuti prima e dopo l'avviso. Fare riferimento alla link:../monitor/collecting-log-files-and-system-data.html["Raccogliere i file di log e i dati di sistema"].
