...
+
image:recovery_reset_button.gif["schermata che mostra la fase in attesa di passaggi manuali"]
...
+
image:recovery_reset_warning.gif["schermata che mostra la finestra di dialogo di avviso di ripristino"]
