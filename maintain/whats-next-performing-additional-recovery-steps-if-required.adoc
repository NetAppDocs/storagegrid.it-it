...
---
= Eseguire ulteriori passaggi di ripristino del nodo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["Recupera il nodo Admin primario usando un nodo Admin non primario"]
