...
---
= Eseguire un riavvio progressivo di StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
TIP: Non puoi riavviare un nodo se è disconnesso dalla grid. Le caselle di controllo sono disabilitate per i nodi con queste icone: image:icon_alarm_gray_administratively_down.png["icona con punto interrogativo grigio"] o image:icon_alarm_blue_unknown.png["icona del punto interrogativo blu"].
