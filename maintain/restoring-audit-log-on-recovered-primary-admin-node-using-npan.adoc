...
summary: Ripristina il registro di controllo sul nodo Admin primario recuperato usando un nodo Admin non primario. 
---
= Ripristina il registro di controllo di StorageGRID su un nodo amministrativo primario recuperato
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Controlla quali file di controllo sono stati conservati: `cd /var/local/audit/export`
