...
---
= Recupera i volumi di storage danneggiati e ricostruisci il database Cassandra in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.E ora?
Dopo che i volumi di archiviazione sono stati riformattati e rimontati e le operazioni Cassandra necessarie sono state completate, puoi link:../maintain/restoring-object-data-to-storage-volume-where-system-drive-is-intact.html["Ripristinare i dati degli oggetti utilizzando Grid Manager"].
