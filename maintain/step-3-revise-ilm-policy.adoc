...
summary: 'Dal passaggio 3 (Rivedi criteri ILM) della procedura guidata Decommission Site, è possibile determinare se il sito è referenziato da qualsiasi criterio ILM.' 
---
= Rivedere le politiche ILM per il decommission di un sito in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
