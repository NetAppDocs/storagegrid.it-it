...
---
= Aggiungi o modifica gli elenchi di subnet sulla Grid Network in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif["schermata descritta dal testo circostante"]
...
+
image:change_ip_tool_gnsl_sample_output.gif["schermata descritta dal testo circostante"]
