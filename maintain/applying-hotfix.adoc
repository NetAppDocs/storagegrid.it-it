...
---
= Applicare un hotfix in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:software_update_landing.png["Landing page per l'aggiornamento del software"]
...
+
image:hotfix_choose_file.png["Hotfix Scegli file"]
...
+
image:hotfix_progress_table.png["Tabella di avanzamento della correzione rapida"]
...
+
image:approve_all_progresstable.png["Aggiornamento rapido in corso con il pulsante di rimozione"]
