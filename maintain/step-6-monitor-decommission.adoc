...
summary: 'Dalla fase 6 (Monitor Decommission) della procedura guidata della pagina Decommission Site (Smantella sito), è possibile monitorare l"avanzamento della procedura di rimozione del sito.' 
---
= Monitora l'avanzamento della decommission del sito in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_6_recovery_package.png["Pacchetto di ripristino del passaggio 6 per la dismissione del sito"]
...
+
image:decommission_site_step_6_data_movement.png["Decommissionare il sito fase 6 spostamento dei dati"]
...
+
image:decommission_site_step_6_storage_node.png["Decommissionare il nodo di storage fase 6 del sito"]
...
+
image:decommission_site_step_6_repair_cassandra.png["Decommissionare il sito fase 6 riparare Cassandra"]
...
+
image:decommission_site_step_6_remove_configuration.png["Decommissionare il sito fase 6 rimuovere la configurazione"]
...
+
image:decommission_site_success_message.png["Messaggio di decommissionazione del sito riuscita"]
