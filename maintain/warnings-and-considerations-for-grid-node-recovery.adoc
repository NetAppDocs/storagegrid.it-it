...
---
= Avvertenze e considerazioni per il ripristino dei nodi StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Se stai ripristinando un nodo della griglia diverso dal nodo amministratore primario, deve esserci connettività tra il nodo della griglia che stai ripristinando e il nodo amministratore che gestisce la procedura di ripristino.
...
Se un server che ospita più di un nodo della griglia si guasta, puoi ripristinare i nodi in qualsiasi ordine. Tuttavia, se il server guasto ospita il nodo di amministrazione primario e non esistono nodi di amministrazione non primari, devi ripristinare prima il nodo di amministrazione primario.
