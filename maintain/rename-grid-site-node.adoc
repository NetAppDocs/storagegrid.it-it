...
---
= Aggiungi o aggiorna i nomi visualizzati di StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Per rimuovere gli elementi che non vuoi rinominare, seleziona image:icon_x_to_remove.png["Icona X."] nella colonna *Rimuovi dall'elenco*.
+
...
. Seleziona image:icon_x_to_remove.png["Icona X."] per rimuovere gli elementi che non vuoi rinominare con questo strumento.
+
Ad esempio, supponi di voler rinominare tutti i nodi che contengono la stringa  `Data-Center-1`, ma non vuoi rinominare il sito  `Data-Center-1` stesso. Seleziona image:icon_x_to_remove.png["Icona X."] per rimuovere il sito dall'anteprima di rinomina.

+
image:rename_bulk_rename_tool.png["In precedenza, rinominare in blocco lo strumento"]
...
+
image:rename_bulk_rename_tool_after.png["Rinominare in blocco dopo"]
...
. Apporta le modifiche aggiuntive necessarie oppure seleziona image:icon_x_to_remove.png["Icona X."] per rimuovere gli elementi che non vuoi rinominare.
...
--
.. Copia il nome di sistema originale di ciascun elemento e incollalo nel campo *Nome visualizzato*, oppure seleziona image:icon_x_to_remove.png["Icona X."] per rimuovere gli elementi che non vuoi ripristinare.
+
...
.. Verifica che ogni voce nel campo *Nome visualizzato* corrisponda al nome nel campo *Nome di sistema*. Apporta le modifiche necessarie o seleziona image:icon_x_to_remove.png["Icona X."] per rimuovere gli elementi che non vuoi ripristinare.
+
Per ripristinare un nome visualizzato, il nome del sistema deve essere visualizzato nel campo *Nome visualizzato*, ma il nome non fa distinzione tra maiuscole e minuscole.
