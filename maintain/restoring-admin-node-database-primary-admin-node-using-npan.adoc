...
summary: 'Ripristina il database dell"Admin Node quando recuperi un Admin Node primario usando un Admin Node non primario.' 
---
= Ripristina il database StorageGRID quando recuperi il nodo di amministrazione primario
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Aggiungi la chiave privata SSH all'agente SSH. Digita: `ssh-add`
...
.. Quando non avrai più bisogno dell'accesso senza password ad altri server, rimuovi la chiave privata dall'agente SSH. Digita: `ssh-add -D`
