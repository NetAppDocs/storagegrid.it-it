...
.Prima di iniziare
* Hai confermato che il nodo di archiviazione ripristinato ha uno stato di connessione *Connesso* image:icon_alert_green_checkmark.png["icona di avviso segno di spunta verde"] nella scheda *Nodi* > *Panoramica* del Grid Manager.
