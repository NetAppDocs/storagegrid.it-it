...
---
= Rimontare e riformattare i volumi di storage StorageGRID (procedura manuale)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Nella maggior parte dei casi, dovresti link:../maintain/restoring-object-data-to-storage-volume.html["Ripristinare i dati degli oggetti utilizzando Grid Manager"]. Rispondi  `y` per utilizzare Grid Manager.
