...
---
= Verificare le condizioni del sistema prima di applicare un hotfix StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
I nodi connessi presentano un segno di spunta verde image:icon_alert_green_checkmark.png["icona di avviso segno di spunta verde"] nella pagina Nodi.
