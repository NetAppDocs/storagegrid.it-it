...
---
= Metti in pausa e riprendi il processo di decommission per i nodi di storage StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_nodes_procedure_paused.png["Decommissionare nodi procedura in pausa"]
