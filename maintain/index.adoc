...
---
= Manutenzione della grid StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: In queste istruzioni, "Linux" si riferisce a una distribuzione Red Hat® Enterprise Linux® (RHEL), Ubuntu® o Debian®.  Per un elenco delle versioni supportate, vedere https://imt.netapp.com/matrix/#welcome["Tool di matrice di interoperabilità NetApp"^] .
