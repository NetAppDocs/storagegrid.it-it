...
---
= Monitorare l'installazione degli appliance di servizi StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. Per monitorare l'avanzamento dell'installazione, seleziona *Monitora installazione* dalla barra dei menu.
+
