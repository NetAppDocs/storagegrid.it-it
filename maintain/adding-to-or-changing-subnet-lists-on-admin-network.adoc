...
---
= Aggiungere o modificare gli elenchi di sottoreti sulla rete di amministrazione in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif["esempio di change ip tool aesl"]
...
+
image:change_ip_tool_aesl_sample_output.png["schermata descritta dal testo circostante"]
