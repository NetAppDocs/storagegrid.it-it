...
summary: 'Puoi aggiungere, rimuovere e aggiornare i server DNS, così puoi usare fully qualified domain name (FQDN) invece degli indirizzi IP.' 
---
= Configurare i server DNS in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. Selezionare *Manutenzione* > *Rete* > *Server DNS*.
. Seleziona l'icona di eliminazione image:icon-x-to-remove.png["icona elimina"] accanto all'indirizzo IP.
. Selezionare *Salva*.
