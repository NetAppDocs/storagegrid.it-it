...
---
= Decommissionare i nodi StorageGRID collegati
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tutti i nodi della griglia hanno uno stato di salute normale (verde) image:icon_alert_green_checkmark.png["icona del segno di spunta verde"]. Se visualizzi una di queste icone nella colonna *Salute*, devi provare a risolvere il problema:
+
[cols="1a,1a,3a"]
|===
| Icona | Colore | Severità 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["icona quadrata gialla"]
 a| 
Giallo
 a| 
Avviso
 ...
 a| 
image:icon_alert_yellow_minor.png["icona a forma di diamante arancione chiaro"]
 a| 
Arancione chiaro
 a| 
Minore
 ...
 a| 
image:icon_alert_orange_major.png["icona a forma di diamante arancione scuro"]
 a| 
Arancione scuro
 a| 
Maggiore
 ...
 a| 
image:icon_alert_red_critical.png["icona x rossa"]
 a| 
Rosso
 a| 
Critico
