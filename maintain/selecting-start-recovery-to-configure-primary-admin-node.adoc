...
summary: Seleziona Avvia ripristino per configurare il nodo Admin primario durante il ripristino del nodo Admin primario. 
---
= Seleziona Avvia ripristino per configurare il nodo Admin primario
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver sostituito un nodo Admin primario, devi selezionare Avvia ripristino in Grid Manager per configurare il nuovo nodo come sostituto del nodo guasto.
