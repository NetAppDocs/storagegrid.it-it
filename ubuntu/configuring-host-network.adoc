...
* Se si utilizzano host virtuali, è necessario leggere prima di configurare la <<mac_address_cloning_ubuntu,Considerazioni e consigli per la clonazione degli indirizzi MAC>>rete host.
