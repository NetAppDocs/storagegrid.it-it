...
summary: Un pool di storage cloud specifica un singolo bucket Amazon S3 esterno o un altro cloud provider compatibile con S3 oppure un container Azure Blob Storage. 
---
...
[role="lead"]
Un pool di storage cloud specifica un singolo bucket Amazon S3 esterno o un altro cloud provider compatibile con S3 oppure un container Azure Blob Storage.
