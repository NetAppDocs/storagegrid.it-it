...
summary: 'Il passaggio 1 (Inserisci i dettagli) della procedura guidata Crea una regola ILM ti permette di inserire un nome e una descrizione per la regola e di definire i filtri per la regola.' 
---
...
image:advanced_filtering_size_between.png["Esempio di filtraggio avanzato per le dimensioni degli oggetti"]
...
image:advanced_filtering_multiple_rows.png["Esempio di filtraggio avanzato per i metadati dell'utente"]
