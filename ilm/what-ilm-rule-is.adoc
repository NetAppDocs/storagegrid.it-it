...
image:ilm_rule_multiple_placements_in_single_time_period.png["Schermata ILM placements (posizionamenti ILM) di Grid Manager"]

La prima istruzione di assegnazione image:icon_number_1.png["Icona numero 1"] ha due righe per il primo anno:
...
La seconda istruzione di collocazione image:icon_number_2.png["Icona numero 1"] crea due copie dopo un anno e conserva tali copie per sempre.
