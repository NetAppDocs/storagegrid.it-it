...
image:ilm_rule_two_copies_two_data_centers.png["ILM regola 1 per esempio 1: Copia dei dati degli oggetti in due siti"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["Regola ILM 2 per l'esempio 1: Profilo di erasure coding con abbinamento bucket"]
...
+
image:policy_1_configured_policy.png["Politica ILM ad esempio 1"]
