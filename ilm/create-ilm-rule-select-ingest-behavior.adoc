...
summary: 'Il passaggio 3 (Seleziona il comportamento di acquisizione) della procedura guidata Crea regola ILM ti permette di scegliere come vengono protetti gli oggetti filtrati da questa regola mentre vengono acquisiti.' 
---
