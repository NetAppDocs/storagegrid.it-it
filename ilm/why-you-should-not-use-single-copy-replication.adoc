...
image:ilm_replication_make_1_copy.png["Replica ILM Copia 1"]
...
image:ilm_replication_make_1_copy_sn_fails.png["Il numero di serie di Make 1 Copy della replica ILM non riesce"]
...
image:ilm_replication_make_2_copies_sn_fails.png["Il numero di serie di 2 copie di ILM Replication non riesce"]
