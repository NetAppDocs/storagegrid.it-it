...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["ILM regola 1 per esempio 3: Utilizzare EC per file di immagini superiori a 1 MB"]
...
image:policy_3_configured_policy.png["Policy ILM per esempio 3: Migliore protezione per i file di immagine"]
