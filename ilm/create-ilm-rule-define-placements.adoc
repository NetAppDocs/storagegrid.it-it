...
image:ilm_create_ilm_rule_wizard_2.png["Creazione guidata regole ILM fase 2"]
...
+
image:ilm_rule_retention_diagram.png["Diagramma di conservazione delle regole ILM"]
