...
Consulta link:using-multiple-storage-pools-for-cross-site-replication.html["Esempi di attivazione della protezione dalle perdite di sito mediante la replica e la cancellazione del codice"].
