...
summary: Quando crei una regola ILM, puoi proteggere gli oggetti in fase di acquisizione specificando Dual commit, Strict o Balanced. 
---
...
image:ingest_object_lifecycle.png["Diagramma che mostra come avviene l'acquisizione di oggetti per ciascuna opzione di acquisizione"]
