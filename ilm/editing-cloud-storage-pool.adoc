...
summary: 'Puoi modificare un Cloud Storage Pool per cambiarne il nome, l"endpoint del servizio o altri dettagli. Tuttavia, non puoi cambiare il bucket S3 o il container Azure di un Cloud Storage Pool.' 
---
