...
summary: 'Puoi modificare un Cloud Storage Pool per cambiarne il nome, l"endpoint del servizio o altri dettagli; tuttavia, non puoi cambiare il bucket S3 o il container Azure per un Cloud Storage Pool.' 
---
