...
image:ilm_rule_apply_only_to_older_object_verions.png["Applica la regola ILM solo alle versioni di oggetti precedenti (ora non corrente)"]
...
link:how-objects-and-delete-markers-are-deleted.html["Come vengono eliminati gli oggetti e i marcatori di eliminazione"]
