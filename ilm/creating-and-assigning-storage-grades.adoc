...
+
.. Per ogni livello di storage personalizzato che vuoi aggiungere, seleziona *Inserisci* image:icon_nms_insert.gif["inserire l'icona"] per aggiungere una riga.
.. Inserire un'etichetta descrittiva.
+
image:editing_storage_grades.gif["Pagina Storage Grades"]

.. Selezionare *Applica modifiche*.
.. Facoltativamente, se devi modificare un'etichetta salvata, seleziona *Modifica* image:icon_nms_edit.gif["icona edit (modifica)"] e seleziona *Applica modifiche*.
+
...
+
.. Individua il nodo di archiviazione nell'elenco LDR e seleziona la relativa icona *Modifica* image:icon_nms_edit.gif["icona edit (modifica)"].
.. Selezionare il livello di storage appropriato dall'elenco.
+
image:assigning_storage_grades_to_storage_nodes.gif["Pagina Storage Grades"]
