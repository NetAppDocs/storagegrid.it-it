...
image:ilm_replication_at_2_sites.png["Replica di 1 copia ciascuno in 2 siti"]

image:ilm_replication_make_2_copies_2_pools_2_sites.png["Eseguire una copia in ciascuno dei 2 siti: Pool di storage specifico del sito"]
...
image:ilm_erasure_coding_site_loss_protection_4+2.png["Pool di storage EC 1 9 nodi di storage 3 siti"]
...
image:ec_three_sites_4_plus_2_site_loss_example_template.png["Memorizzare gli oggetti cancellando il codice utilizzando uno schema EC 4+2 in 3 siti"]

In caso di perdita di un sito, è possibile recuperare i dati:

image:ec_three_sites_4_plus_2_site_loss_example.png["Erasure coding 4+2 EC schema 1 sito perso"]
