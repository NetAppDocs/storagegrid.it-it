...
+
image:alerts_create_custom_rule.png["Avvisi > Crea regola personalizzata"]
...
+
Per visualizzare le metriche disponibili e testare le espressioni Prometheus, seleziona l'icona di aiuto image:icon_nms_question.png["icona del punto interrogativo"] e segui il collegamento alla sezione Metrics dell'API Grid Management.
