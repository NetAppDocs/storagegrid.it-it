...
Per i dettagli sulla sintassi delle query di Prometheus, vedi  https://prometheus.io/docs/prometheus/latest/querying/basics/["Nozioni di base sulle interrogazioni"^].
...
+
image:nodes_page_network_traffic_graph.png["Grafico Prometheus"]
