...
+
Seleziona l'icona più image:icon_plus_sign_black_on_white.gif["icona più"] per aggiungere i destinatari.
...
NOTE: Se devi modificare le impostazioni dell'email, seleziona l'icona della matita image:icon_edit_tm.png["Icona Edit (Modifica)"] per aggiornare questo campo.
