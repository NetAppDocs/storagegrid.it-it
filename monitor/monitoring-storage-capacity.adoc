...
+
image:dashboard_data_and_metadata_space_usage_breakdown.png["Analisi dell'utilizzo dello spazio di dati e metadati"]
...
+
image:dashboard_storage_over_time.png["Grafico dello storage nel tempo"]
...
+
image:nodes_deployment_storage_tab.png["Scheda Node Deployment Storage (Storage di implementazione"]
...
image:calculating_watermarks.gif["Disegno concettuale per lo spazio utilizzabile totale"]
...
+
image:nodes_page_storage_used_object_data.png["Nodes Page Storage Uused Object Data"]
...
NOTE: Per visualizzare i grafici di questi valori, clicca sulle icone dei grafici image:icon_chart_new_for_11_5.png["Icona del grafico"] nelle colonne Disponibili.

+
image:nodes_page_storage_tables.png["L'oggetto memorizza le tabelle"]
...
image:forecast-metadata-usage.png["Previsione dell'utilizzo dei metadati per sito"]
