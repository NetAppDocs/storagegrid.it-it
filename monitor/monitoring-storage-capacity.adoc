...
NOTE: Per visualizzare i grafici di questi valori, seleziona le icone dei grafici nelle colonne disponibili.
...
image:forecast_metadata_usage.png["Previsione dell'utilizzo dei metadati per sito"]
