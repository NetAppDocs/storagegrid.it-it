...
+
image:nodes_storage_node_object_verification.png["Nodi > Nodo di archiviazione > Oggetto > Verifica"]
...
+
image:nodes_storage_node_ilm_ec_verification.png["Nodi > Nodo di archiviazione > ILM > Verifica EC"]

+
Seleziona il punto interrogativo image:icon_nms_question.png["punto interrogativo"] accanto al nome di un attributo per visualizzare il testo di aiuto.
...
+
image:oec_job_history.png["Cronologia del processo di controllo dell'esistenza di oggetti"]
