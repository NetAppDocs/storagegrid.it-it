...
+
image:grid_federation_connections_tab.png["Scheda Grid Federation Connections"]
...
+
image:grid_federation_permitted_tenants_tab.png["Scheda tenant consentiti per la federazione di griglie"]
