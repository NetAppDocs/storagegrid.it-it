...
+
image:grid-federation-connections-tab.png["Scheda Grid Federation Connections"]
...
+
image:grid-federation-permitted-tenants-tab.png["Scheda tenant consentiti per la federazione di griglie"]
