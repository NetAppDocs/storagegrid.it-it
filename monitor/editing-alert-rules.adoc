...
+
image:alert_rules_edit_rule.png["Avvisi > Modifica regola"]
...
+
image:alert_rules_edit_revert_to_default.png["Alert rules (regole di avviso): Ripristino di una condizione modificata al valore predefinito"]
