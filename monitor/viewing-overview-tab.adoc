...
* *Indirizzi IP*: Gli indirizzi IP del nodo. Seleziona *Mostra indirizzi IP aggiuntivi* per visualizzare gli indirizzi IPv4 e IPv6 del nodo e le mappature delle interfacce.
