...
image:grid_manager_dashboard.png["Dashboard di Grid Manager"]
...
|===
Alcune schede possono essere ingrandite per una visualizzazione più agevole. Seleziona l'icona di ingrandimento image:icon_dashboard_card_maximize.png["Icona Ingrandisci"] nell'angolo in alto a destra della scheda. Per chiudere una scheda ingrandita, seleziona l'icona di riduzione image:icon_dashboard_card_minimize.png["Icona Riduci a icona"] oppure seleziona *Close*.
...
image:dashboard_manage.png["Gestire i dashboard"]
...
image:dashboard_configure.png["Configurare la dashboard"]
