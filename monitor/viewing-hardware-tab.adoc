...
+
image:nodes_page_hardware_tab_for_appliance.png["Scheda Nodes Page hardware (hardware pagina nodi) per Appliance"]
...
+
image:nodes_page_network_communication.png["COM. Rete pagina nodi"]
...
+
image:nodes_page_storage_tables.png["Tabelle di archiviazione delle pagine dei nodi"]
...
+
image:nodes_page_hardware_tab_services_appliance.png["Scheda hardware della pagina nodi per l'appliance di servizi"]
...
.. Consultare la sezione interfacce di rete.
+
image:nodes_page_hardware_tab_network_services_appliance.png["Pagina nodi scheda hardware Network Services Appliance"]
...
+
image:nodes_page_storage_tab_services_appliance.png["Scheda Nodes Page Storage Services Appliance"]
