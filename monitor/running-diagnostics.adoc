...
* image:icon_alert_green_checkmark.png["Icona Avviso segno di spunta verde"] *Normale*: Tutti i valori rientrano nell'intervallo normale.
* image:icon_alert_yellow_minor.png["Icona Avviso giallo minore"]*Attenzione*: uno o più valori sono al di fuori dell'intervallo normale.
* image:icon_alert_red_critical.png["Icona Avviso rosso critico"]*Attenzione*: uno o più valori sono significativamente al di fuori dell'intervallo normale.
...
+
image:support_diagnostics_page.png["Pagina Support Diagnostics (Diagnostica di supporto)"]

. Per saperne di più su una diagnosi specifica, seleziona quella riga.
+
...
+
image:support_diagnostics_cpu_utilization.png["Esempio di valori di stato della diagnostica"]
...
+
image:grafana_dashboard_nodes.png["Nodi del dashboard Grafana"]

. *Opzionale*: Per visualizzare un grafico dell'espressione di Prometheus nel tempo, seleziona *Visualizza in Prometheus*.
+
Viene visualizzato un grafico Prometheus dell'espressione utilizzata nella diagnostica.

+
image:support_diagnostics_prometheus_png.png["Pagina Support Diagnostics Prometheus (Prometheus diagnostica di supporto)"]
