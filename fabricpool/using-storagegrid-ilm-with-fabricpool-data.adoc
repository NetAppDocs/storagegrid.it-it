...
---
= Configura StorageGRID ILM per i dati FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Se hai eseguito l'aggiornamento a StorageGRID 12.1 da una versione di StorageGRID precedente alla 11.7, hai configurato il pool di storage che utilizzerai. In generale, dovresti creare un pool di storage per ogni sito StorageGRID che utilizzerai per archiviare i dati. (A partire dalla versione 11.7, i pool di storage vengono creati automaticamente per ogni sito.)
+
