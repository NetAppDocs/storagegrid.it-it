...
summary: 'Quando configuri StorageGRID per l"utilizzo con FabricPool, puoi facoltativamente creare uno o più gruppi ad alta disponibilità (HA).' 
---
= Crea un gruppo ad alta disponibilità (HA) per FabricPool in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
