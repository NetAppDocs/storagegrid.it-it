...
summary: 'Questo messaggio viene generato ogni volta che non è possibile trovare una posizione per una copia di un oggetto (replicata o codificata con cancellazione).' 
---
= Messaggio di audit LLST per le posizioni di copia degli oggetti persi in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
