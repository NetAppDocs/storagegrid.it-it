...
----
Per informazioni sull'impostazione dei livelli dei messaggi di audit, sulla modifica delle destinazioni dei log e sull'utilizzo di un server syslog esterno per le informazioni di audit, vedere link:../monitor/configure-audit-messages.html["Configurare i messaggi di controllo e il server syslog esterno"]
