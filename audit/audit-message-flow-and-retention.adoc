...
image:audit_message_flow.gif["Diagramma che riepiloga il flusso dei messaggi di audit attraverso i relay"]
...
image:audit_message_retention.gif["Diagramma che riassume la ricezione del messaggio di audit presso l'AMS"]
