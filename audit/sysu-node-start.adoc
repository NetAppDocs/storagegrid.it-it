...
summary: 'Quando un servizio viene riavviato, questo messaggio viene generato per indicare se l"arresto precedente era pulito (comandato) o disordinato (imprevisto).' 
---
= Messaggio di audit SYSU per il nodo avviato in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
