...
summary: 'Puoi usare lo strumento audit-sum per contare i messaggi di audit di scrittura, lettura, head ed eliminazione e per vedere il tempo (o la dimensione) minimo, massimo e medio per ciascun tipo di operazione.' 
---
