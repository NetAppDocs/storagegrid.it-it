...
summary: Il messaggio di audit LKDM viene generato quando un chunk perso è stato ripulito o eliminato. 
---
= Messaggio di audit LKDM per la pulizia degli oggetti trapelati in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
