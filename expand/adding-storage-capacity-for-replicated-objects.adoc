...
summary: 'Se il criterio ILM (Information Lifecycle Management) per l"implementazione include una regola che crea copie replicate di oggetti, è necessario considerare la quantità di storage da aggiungere e la posizione in cui aggiungere i nuovi volumi di storage o i nuovi nodi di storage.' 
---
= Pianificazione dell'espansione per i dati replicati in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
