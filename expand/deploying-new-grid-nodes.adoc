...
---
= Distribuisci nuovi nodi della griglia in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se devi accedere manualmente alla pagina di installazione del monitor, seleziona *Installazione monitor* dalla barra dei menu.
+
La pagina di installazione di Monitor mostra lo stato di avanzamento dell'installazione.
