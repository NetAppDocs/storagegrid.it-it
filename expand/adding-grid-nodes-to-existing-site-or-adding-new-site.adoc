...
---
= Riepilogo del flusso di lavoro per l'aggiunta di nodi della griglia o nuovi siti a StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. link:updating-subnets-for-grid-network.html["Aggiorna le subnet per la rete Grid"].
. link:deploying-new-grid-nodes.html["Distribuisci i nuovi nodi della griglia"].
