...
---
= Linee guida per l'aggiunta di capacità di metadati in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:metadata_space_after_expansion.png["Diagramma dei metadati ridistribuiti dopo l'aggiunta di due nodi di storage"]
