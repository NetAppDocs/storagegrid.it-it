...
---
= Aggiungi volumi di archiviazione al tuo sistema StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_storage_tables_vol_expansion.png["Tabelle di archiviazione delle pagine dei nodi"]
