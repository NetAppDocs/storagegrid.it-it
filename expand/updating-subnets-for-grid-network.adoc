...
---
= Aggiungere o aggiornare le subnet alla rete Grid per l'espansione in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Non utilizzare sottoreti che contengono i seguenti indirizzi IPv4 per la Grid Network, l'Admin Network o la Client Network di alcun nodo:
...
Ad esempio, non usare i seguenti intervalli di sottorete per la Grid Network, l'Admin Network o la Client Network di alcun nodo:
