...
---
= Ripristina un oggetto in StorageGRID con la richiesta S3 RestoreObject
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
*Importante*: se un oggetto è stato migrato su S3 Glacier Deep Archive o se il Cloud Storage Pool utilizza Azure Blob Storage, non puoi ripristinarlo usando il `Expedited` livello. Viene restituito il seguente errore `403 Forbidden`, `InvalidTier`: `Retrieval option is not supported by this storage class`.
