...
summary: 'La richiesta PUT Bucket last access time consente di abilitare o disabilitare gli aggiornamenti dell"ultimo orario di accesso per singoli bucket.' 
---
= Abilita e disabilita gli aggiornamenti dell'ora dell'ultimo accesso in StorageGRID con la richiesta PUT Bucket last access time
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
