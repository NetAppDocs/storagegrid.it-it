...
---
= Intestazioni e opzioni delle richieste S3 CreateMultipartUpload in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se la richiesta CreateMultipartUpload non specifica un checksum, StorageGRID non calcola un checksum CRC-64/NVME predefinito per un oggetto. StorageGRID ignora valori  `x-amz-checksum-algorithm` non validi o non supportati.
