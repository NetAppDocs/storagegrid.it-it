...
---
= Operazioni supportate e limitazioni dell'API REST S3 in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Il sistema StorageGRID supporta sia le richieste in stile virtual-hosted che quelle in stile path.
