...
summary: Puoi usare la federazione di griglia per sincronizzare i tenant e replicare i loro oggetti tra più sistemi StorageGRID per il ripristino di emergenza. 
---
...
[role="lead"]
Puoi usare la federazione di griglia per sincronizzare i tenant e replicare i loro oggetti tra più sistemi StorageGRID per il ripristino di emergenza.
...
image:grid_federation_workflow.png["Workflow di connessione a Grid Federation"]
...
+
Per i dettagli sui requisiti di versione, fare riferimento a https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Note di rilascio"^]. È necessario accedere con il proprio account NetApp o crearne uno per accedere alle note di rilascio.
...
* Deve esistere almeno una connessione di federazione della griglia prima di poter utilizzare link:grid-federation-what-is-account-sync.html["sincronizzazione account"] o link:grid-federation-what-is-cross-grid-replication.html["replica cross-grid"].
...
image:grid_federation_certificates.png["Certificati di federazione grid"]
