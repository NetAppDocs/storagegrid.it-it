...
image:grid-federation-workflow.png["Workflow di connessione a Grid Federation"]
...
+
Per i dettagli sui requisiti di versione, fare riferimento a https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Note di rilascio"^]. È necessario accedere con il proprio NetApp account o crearne uno per accedere alle note di rilascio.
...
image:grid-federation-certificates.png["Certificati di federazione grid"]
