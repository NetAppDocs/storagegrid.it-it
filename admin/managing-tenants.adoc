...
summary: 'Un account tenant consente di utilizzare l"API REST S3 (Simple Storage Service) per memorizzare e recuperare gli oggetti in un sistema StorageGRID.' 
---
= Account tenant in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Usa la federazione di griglia per la sincronizzazione degli account e la replica tra griglie
