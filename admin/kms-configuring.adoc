...
summary: 'Un server di gestione delle chiavi (KMS) è un sistema esterno di terze parti che fornisce chiavi di crittografia ai nodi dell"appliance StorageGRID presso il sito StorageGRID associato utilizzando il Key Management Interoperability Protocol (KMIP)' 
---
