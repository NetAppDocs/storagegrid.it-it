...
image:grid-federation-cgr-workflow.png["Workflow di replica cross-grid"]
...
image:grid-federation-cross-grid-replication-one-direction.png["immagine che mostra la connessione a federazione di griglie in una direzione"]
...
image:grid-federation-cross-grid-replication.png["immagine che mostra la replica in una direzione rispetto alla replica in entrambe le direzioni"]
...
image:grid-federation-cross-grid-replication-delete.png["immagine che mostra l'eliminazione del client replicato su entrambe le griglie"]
