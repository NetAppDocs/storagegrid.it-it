...
---
= Consegna per sito dei messaggi dei servizi della piattaforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:notification_multiple_sites.gif["Diagramma che mostra che l'azione sull'oggetto nel sito 1 attiva la notifica dal sito 1"]
...
image:notifications_site_2.gif["diagramma che mostra l'azione sull'oggetto dal sito 2 attiva le notifiche dal sito 2"]
