...
summary: Se un tentativo di invio di un pacchetto AutoSupport non va a buon fine, il sistema StorageGRID adotta azioni diverse a seconda del tipo di pacchetto AutoSupport. 
---
= Risoluzione dei problemi dei pacchetti StorageGRID AutoSupport
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
