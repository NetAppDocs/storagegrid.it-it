...
NOTE: A partire da StorageGRID 12.1.0, il supporto per la crittografia AES-128 dei nuovi dati degli oggetti archiviati a riposo è deprecato. Il supporto continua per il recupero degli oggetti archiviati che erano stati originariamente crittografati con AES-128.
