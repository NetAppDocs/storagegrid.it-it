...
*Nota:* se SSO è abilitato e si è anche connessi al Tenant Manager, è necessario anche accedere link:../tenant/signing-out-of-tenant-manager.html["disconnettersi dall'account tenant"]a link:how-sso-works.html["Disconnettersi da SSO"].
