...
|===
+
Ad esempio, se si desidera creare un limite di larghezza di banda di 4 GB/s per un livello SLA, creare due limiti di larghezza di banda aggregati: GET/HEAD a 4 GB/s e PUT/POST/DELETE a 4 GB/s.
