...
---
= Modificare un account tenant di StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Seleziona la scheda Grid federation nella pagina dei dettagli del tenant.
... Seleziona la connessione che vuoi rimuovere.
