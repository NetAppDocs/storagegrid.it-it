...
summary: Quando i nodi di archiviazione raggiungono la capacità massima, devi espandere il sistema StorageGRID aggiungendo nuovo storage. Puoi farlo aggiungendo volumi di storage, shelf di espansione dello storage e nodi di archiviazione. 
---
