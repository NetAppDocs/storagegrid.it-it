...
summary: 'Quando i nodi di archiviazione raggiungono la capacità, devi espandere il sistema StorageGRID aggiungendo nuovo storage. Hai tre opzioni disponibili: aggiungere volumi di storage, aggiungere shelf di espansione dello storage e aggiungere nodi di archiviazione.' 
---
= Gestisci nodi di storage completi in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
