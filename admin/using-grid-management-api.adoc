...
.Fasi
. Dall'intestazione di Grid Manager, seleziona l'icona di aiuto image:icon_help_menu_bar.png["Icona di aiuto"] e seleziona *Documentazione API*.
...
+
image:swagger_example.png["Esempio dall'interfaccia utente di Swagger"]
