...
---
= Confronta la replica cross-grid e la replica CloudMirror in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Aggiungi nuovi account tenant, che vengono sincronizzati automaticamente con l'altra grid.
. Aggiungi nuovi gruppi di tenant e utenti, che vengono anch'essi sincronizzati.
