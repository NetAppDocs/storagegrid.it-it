...
image:link_costs.gif["Diagramma concettuale per i costi di collegamento tra i data center"]
...
+
image:configuring_link_costs.png["Costo del collegamento"]
...
+
Per annullare le modifiche, seleziona image:nms_revert.gif["icona di annullamento"]*Revert*.
