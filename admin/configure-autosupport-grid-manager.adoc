...
* *Raccolta registri*:link:../monitor/collecting-log-files-and-system-data.html["Raccogliere manualmente i file di registro e i dati di sistema e inviare un pacchetto AutoSupport"].
