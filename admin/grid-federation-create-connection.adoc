...
summary: Puoi creare connessioni di federazione di griglia tra sistemi StorageGRID se vuoi sincronizzare i dettagli dei tenant e replicare i dati degli oggetti. 
---
...
[role="lead"]
Puoi creare connessioni di federazione di griglia tra sistemi StorageGRID se vuoi sincronizzare i dettagli dei tenant e replicare i dati degli oggetti.
...
TIP: Facoltativamente, puoi link:../admin/grid-federation-automate-connections.html["automatizza la creazione, la modifica e la manutenzione delle connessioni di federazione della griglia"].

image:grid_federation_create_connection.png["panoramica grafica dei passaggi per la creazione di una connessione su due griglie"]
...
. Inserisci un nome di connessione, ovvero un nome univoco che ti aiuta a riconoscere questa connessione. Ad esempio, `Grid 1-Grid 2`.
. Se vuoi link:../admin/configure-global-namespace.html["configurare uno spazio dei nomi globale"], seleziona *Abilita spazio dei nomi globale*.
. Selezionare *continua*.
. Inserisci i dettagli della griglia come segue:
...
* link:grid-federation-troubleshoot.html["Risolvere i problemi di connessione"], compresa la risoluzione di eventuali avvisi ed errori relativi alla sincronizzazione degli account e alla replica cross-grid.
