...
+
image:grid-federation-retry-account-clone.png["Schermata che mostra un messaggio di errore e il pulsante Retry account clone"]Se l'errore è stato risolto, il tenant account verrà ora clonato sull'altra griglia.
...
image:grid-federation-last-error.png["Schermata che mostra un messaggio nella colonna Last error (ultimo errore) di una connessione a federazione di griglie"]
