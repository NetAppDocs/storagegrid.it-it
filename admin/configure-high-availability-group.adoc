...
summary: 'È possibile configurare i gruppi ad alta disponibilità (ha) per fornire l"accesso altamente disponibile ai servizi sui nodi Admin o Gateway.' 
---
...
+
image:ha_group_add_interfaces.png["Gruppi HA Aggiungi interfacce"]
...
+
image:vlan_parent_interface_tooltip.png["Suggerimento per l'interfaccia VLAN"]
...
+
image:ha_group_determine_failover.png["I gruppi HA determinano l'ordine di priorità"]
...
+
image:ha_group_select_virtual_ips.png["I gruppi HA inseriscono i VIP"]
