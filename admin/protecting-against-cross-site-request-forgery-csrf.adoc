...
summary: 'Puoi contribuire a proteggere StorageGRID dagli attacchi Cross-Site Request Forgery (CSRF) utilizzando i token CSRF per rafforzare l"autenticazione che si basa sui cookie.' 
---
