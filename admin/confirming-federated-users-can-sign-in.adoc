...
summary: 'Prima di attivare il Single Sign-on (SSO), è necessario confermare che almeno un utente federato possa accedere a Grid Manager e a Tenant Manager per qualsiasi account tenant esistente.' 
---
= Conferma che gli utenti federati possano eseguire Sign in a StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
