...
+
image:vlan_create_parent_interfaces.png["Creazione guidata VLAN interfacce principali"]
...
** Se devi rimuovere un'interfaccia padre, seleziona l'icona del cestino image:icon_trash_can.png["icona del cestino"].
