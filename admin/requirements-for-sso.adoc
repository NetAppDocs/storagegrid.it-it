...
StorageGRID supporta diversi provider di identità (IdP) SSO.

[role="tabbed-block"]
====
.OIDC
--
I seguenti SSO IdPs sono supportati per OpenID Connect (OIDC):
...
.SAML
--
I seguenti SSO IdPs sono supportati per Security Assertion Markup Language 2.0 (SAML 2.0):
