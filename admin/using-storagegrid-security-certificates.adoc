...
*** link:creating-relying-party-trusts-in-ad-fs-saml.html#create-a-relying-party-trust-manually["Specificare manualmente un certificato SSO per un trust della parte che si basa"]
