...
* Hailink:../admin/configure-sso.html["entrato in modalità sandbox"] in Grid Manager.
...
. Al termine, tornare a StorageGRID elink:../admin/configure-sso.html#test-sso["testare tutti i trust delle parti affidanti"] per confermare che siano configurati correttamente.
