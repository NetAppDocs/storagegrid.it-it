...
NOTE: CloudMirror replication è supportata solo se il bucket di origine ha S3 Object Lock abilitato e l'endpoint è un bucket S3 di Amazon o StorageGRID. Le impostazioni di Object Lock non vengono replicate nell'endpoint del bucket.
