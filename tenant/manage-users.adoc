...
summary: 'Puoi creare utenti locali e assegnarli a gruppi locali per determinare a quali funzionalità questi utenti possono accedere. Il Tenant Manager include un utente locale predefinito, denominato  `root`, Anche se puoi aggiungere e rimuovere utenti locali, non puoi rimuovere l"utente root.' 
---
