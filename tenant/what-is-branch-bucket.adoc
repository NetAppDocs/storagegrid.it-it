...
* Stai salvando dati in un bucket versionato. C'è stata una vulnerabilità accidentale che ha causato l'ingestione di molti oggetti indesiderati tra il tempo _T1_ e _T2_. Puoi creare un bucket di diramazione per i valori di tempo _Exclude_, _T1_ e _T2_, e reindirizzare le operazioni dei client a quel bucket di diramazione. Così, solo gli oggetti ingeriti prima di _T1_ e dopo _T2_ saranno esposti ai client.
...
Consultare anche link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Modalità di eliminazione degli oggetti con versione S3"].
