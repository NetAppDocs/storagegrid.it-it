...
Non puoi eliminare un bucket S3 se contiene oggetti, versioni di oggetti non correnti o marcatori di eliminazione. Per informazioni su come vengono eliminati gli oggetti S3 con versione, consulta link:../ilm/how-objects-and-delete-markers-are-deleted.html["Come vengono eliminati gli oggetti e i marcatori di eliminazione"].
