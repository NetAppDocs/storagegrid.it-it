...
* *s3-configurations*: Operazioni per recuperare le configurazioni globali di S3.
...
image:tenant_api_swagger_example.gif["Esempio che mostra l'operazione GET groups nell'API Swagger"]
