...
+
image:delete_bucket_objects_in_progress.png["schermata che mostra gli oggetti bucket eliminati"]
...
+
image:delete_bucket_objects_complete.png["schermata che mostra tutti gli oggetti bucket cancellati"]
