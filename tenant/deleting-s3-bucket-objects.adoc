...
+
image:delete-bucket-objects-in-progress.png["schermata che mostra gli oggetti bucket eliminati"]
...
+
image:delete-bucket-objects-complete.png["schermata che mostra tutti gli oggetti bucket cancellati"]
