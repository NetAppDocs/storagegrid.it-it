...
* Per l'utente è stato configurato un criterio di gruppo o bucket S3. Vedere link:../s3/use-access-policies.html["Utilizza policy di accesso a bucket e gruppi"] .
