...
---
= Visualizza e modifica i dettagli del gruppo di tenant in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_group_details.png["Visualizza dettagli gruppo"]
...
+
.. Facoltativamente, seleziona il nome visualizzato o l'icona di modifica image:icon_edit_tm.png["Icona Edit (Modifica)"] per aggiornare il nome visualizzato.
+
