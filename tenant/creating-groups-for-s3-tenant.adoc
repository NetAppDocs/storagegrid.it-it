...
+
Se il tuo tenant account dispone dell'autorizzazione *Usa connessione di federazione griglia* e ti trovi sulla griglia di origine del tenant, il nuovo gruppo viene sincronizzato con la griglia di destinazione del tenant. *Riuscito* appare come stato di sincronizzazione nella sezione Panoramica della pagina dei dettagli del gruppo.
