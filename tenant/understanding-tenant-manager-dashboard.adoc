...
image:tenant_dashboard_with_buckets.png["Dashboard - elenco bucket"]
...
+
image:tenant_dashboard_storage_usage_segment.png["Segmento del grafico a barre"]
...
+
image:tenant_dashboard_buckets.png["Bucket del pannello di controllo del tenant"]
...
image:tenant_dashboard_endpoint_error.png["Dashboard che mostra il messaggio dell'endpoint"]
