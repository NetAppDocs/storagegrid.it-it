...
---
= Requisiti di migrazione del container del nodo StorageGRID per Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:eth0_bond.gif["Questa immagine viene spiegata dal testo circostante."]
...
image:block_device_mapping_rhel.gif["Mappatura dei dispositivi a blocchi"]
