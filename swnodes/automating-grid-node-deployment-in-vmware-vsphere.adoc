...
summary: È possibile utilizzare VMware OVF Tool per automatizzare la distribuzione dei nodi grid in StorageGRID. È anche possibile automatizzare la configurazione di StorageGRID. 
---
= Automatizza la distribuzione dei nodi della griglia in StorageGRID con VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
