...
---
= Informazioni e materiali necessari per StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
Consulta link:../network/index.html["Linee guida per il networking"].
...
+
--
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Note di rilascio"^]. È necessario accedere con il proprio account NetApp o crearne uno per accedere alle note di rilascio.
