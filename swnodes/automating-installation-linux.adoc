...
summary: 'È possibile automatizzare l"installazione del servizio host StorageGRID e la configurazione dei nodi grid su Linux.' 
---
= Automatizza l'installazione del servizio host StorageGRID e la configurazione dei nodi grid su Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
