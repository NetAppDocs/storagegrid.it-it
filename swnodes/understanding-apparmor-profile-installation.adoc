...
----
* Disabilita AppArmor completamente. Per Ubuntu 9.10 o versioni successive, segui le istruzioni in  https://help.ubuntu.com/community["Comunità online di Ubuntu"]. Disabilitare completamente AppArmor potrebbe non essere possibile nelle versioni più recenti di Ubuntu.
+
