...
---
= Convalida la configurazione di StorageGRID su Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:rhel_node_configuration_file_output.gif["Questa immagine viene spiegata dal testo circostante."]
...
image:rhel_node_configuration_file_output_with_errors.gif["Questa immagine viene spiegata dal testo circostante."]
