...
summary: 'StorageGRID 12.0 utilizza la versione 4 dell"API di gestione della griglia. La versione 4 sostituisce la versione 3. Tuttavia, le versioni 1, 2 e 3 sono ancora supportate.' 
---
