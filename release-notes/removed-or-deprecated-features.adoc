...
sidebar: sidebar 
keywords:  
summary: 'Scopri le funzionalità e le caratteristiche rimosse o deprecate in StorageGRID 12.0. Prima di eseguire l"aggiornamento, verifica se le funzionalità rimosse o deprecate influiscono sulle tue applicazioni client o sulla configurazione della griglia.' 
---
...
[role="lead"]
Scopri le funzionalità e le caratteristiche rimosse o deprecate in StorageGRID 12.0. Prima di eseguire l'aggiornamento, verifica se le funzionalità rimosse o deprecate influiscono sulle tue applicazioni client o sulla configurazione della griglia.
