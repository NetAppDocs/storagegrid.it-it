...
summary: StorageGRID 12.0 utilizza la versione 4 della Tenant Management API. La versione 4 depreca la versione 3. Tuttavia, le versioni 1, 2 e 3 sono ancora supportate. 
---
