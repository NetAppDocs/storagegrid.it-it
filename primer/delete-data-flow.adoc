...
Consulta link:../ilm/how-objects-and-delete-markers-are-deleted.html["Come vengono eliminati gli oggetti e i marcatori di eliminazione"] per ulteriori informazioni.
...
image:delete_data_flow.png["Flusso di dati di eliminazione del client"]
...
image:automatic_deletion_data_flow.png["Flusso di dati per l'eliminazione automatica"]
