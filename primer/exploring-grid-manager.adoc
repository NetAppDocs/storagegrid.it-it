...
image:grid_manager_dashboard_and_menu.png["Dashboard in Grid Manager"]

Per una spiegazione delle informazioni visualizzate su ciascuna scheda, seleziona l'icona di aiuto image:icon_nms_question.png["icona del punto interrogativo"] per quella scheda.
...
Il menu di aiuto image:icon_help_menu_bar.png["icona della guida sulla barra dei menu"] offre accesso a:
...
* Usa link:../admin/grid-federation-overview.html["federazione di grid"] per sincronizzare le informazioni dell'account del tenant e replicare i dati degli oggetti tra due sistemi StorageGRID
...
* link:../monitor/configure-email-server.html["Configura il server di posta elettronica"]
...
* link:../admin/about-multi-admin-verify.html["Configura la verifica multi-amministratore"]
...
* Ripristino dei dati dell'oggetto
+
...
* link:../monitor/configure-autosupport-grid-manager.html["Configurare AutoSupport"]
