...
image:replication_data_flow.png["diagramma che mostra il processo descritto nel testo circostante"]
...
image:erasure_coding_data_flow.png["Erasure coding Data Flow (Erasure Coding Data Flow"]
...
image:cloud_storage_pool_data_flow.png["Flusso di dati del pool di cloud storage"]
