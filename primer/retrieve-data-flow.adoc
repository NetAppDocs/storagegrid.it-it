...
image:retrieve_data_flow.png["Recuperare"]
...
. Il servizio LDR di origine restituisce i dati dell'oggetto recuperato al servizio LDR interrogato e il sistema restituisce l'oggetto all'applicazione client.
