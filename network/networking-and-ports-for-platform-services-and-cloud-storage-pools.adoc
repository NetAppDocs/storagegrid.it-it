...
I pool di cloud storage richiedono inoltre l'accesso dai nodi di storage agli endpoint forniti dal servizio esterno utilizzato, come Amazon S3 Glacier o Microsoft Azure Blob Storage. Per informazioni, vedi link:../ilm/what-cloud-storage-pool-is.html["Che cos'è un Cloud Storage Pool"].
