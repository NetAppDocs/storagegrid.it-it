...
summary: 'Il firewall interno di StorageGRID consente connessioni in entrata solo su porte specifiche della Grid Network, ad eccezione delle porte 22, 80, 123 e 443 (vedi le informazioni sulle comunicazioni esterne). Le connessioni sono accettate anche sulle porte definite dagli endpoint del load balancer.' 
---
...
Appliance
 a| 
Nodo Admin primario e nodo Admin non primario
 a| 
